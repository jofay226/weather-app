...
import { BsCloudHaze2Fill, BsCloudDrizzleFill, BsEye, BsWater, BsThermometer, bsWind, BsWind   } from 'react-icons/bs';
import { TbTemperatureCelsius} from 'react-icons/tb';
import { ImSpinner8 } from 'react-icons/im';

const APIkey = 'aea29512fc025f3fd74a064ef4d95c73';
...
const App = () => {
  ...
  return <div className='w-full h-screen bg-gradientBg bg-no-repeat bg-cover bg-center flex flex-col items-center justify-center px-4 lg:px-0'>
    ...
    {errorMsg && <div className='w-full max-w-[90vw] lg:max-w-[450px] bg-[#ff208c] text-white absolute top-2 lg:top-10 p-4 capitalize rounded-t-md'>{`${errorMsg.response.data.message}`}</div>  }
